...
// console.log(items);
    ...
    return(
        <>
            ...
            <div class="m-b30">
    <p>
        سلام <strong class="text-black">{user.firstname} {user.lastname}</strong> (<strong class="text-black"> {user.firstname} {user.lastname} </strong> نیستید ؟ 
        <Link href="login.html" class="text-underline"> خروج </Link>)
    </p>
    <p>
        از داشبورد حساب کاربری خود می‌توانید <Link href="account-orders.html" class="text-underline">سفارشات اخیر</Link> خود را مشاهده کنید، 
        <Link href="account-address.html" class="text-underline">آدرس‌های حمل و نقل و صورتحساب</Link> خود را مدیریت کنید، 
        و <Link href="account-profile.html" class="text-underline">رمز عبور و جزئیات حساب کاربری</Link> خود را ویرایش کنید.
    </p>
</div>
							...
							<div class="row g-4">
								<div class="col-md-4">
									<div class="total-contain">
										...
										<div class="total-detail">
											<span class="text"> {Lang('public.total')} {Lang('public.orders')}</span>
								...
								<div class="col-md-4">
									<div class="total-contain">
										...
										<div class="total-detail">
											<span class="text"> {Lang('public.orders')} {Lang('public.pending')}</span>
								...
								<div class="col-md-4">
									<div class="total-contain">
										...
										<div class="total-detail">
											<span class="text">{Lang('public.wishlist')}</span>
