...
class Tools{
    ...
    {
        $userRegister = \Models\Edu\Register::where(['user_id' => $user_id, 'code' => $course])->first();
        return $userRegister->group;
    }
     ...
     *              {
     *                  return $this->belongsToMany(\Models\Person\User::class, 'shop_advs_logs', 'adv_id', 'user_id')
